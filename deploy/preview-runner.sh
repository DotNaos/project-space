...
assert_state_transition() {
  ...
  case "$current_state:$next_state" in
    building:ready|building:failed|ready:ready|ready:starting|ready:online|ready:failed|starting:starting|starting:online|starting:failed|online:online|online:stopping|online:failed|update_failed:online|update_failed:stopping|stopping:stopping|stopping:ready|stopping:online|stopping:failed|failed:failed|failed:ready|failed:starting|failed:online|expired:ready|removed:building|removed:ready) ;;
