...
const primaryProjectUiFiles = [
  ...
  'src/features/project-desktop/components/machines-page.tsx',
  'src/features/project-desktop/components/machines-page-model.ts',
  'src/features/project-desktop/components/compute-source-rows.tsx',
  'src/features/project-desktop/hooks/use-compute-sources.ts',
