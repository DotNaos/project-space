const clientSecretPatterns: readonly RegExp[] = [
...
export function isProjectChatMessageSafe(value: string) {
  return !clientSecretPatterns.some((pattern) => pattern.test(value));
}
