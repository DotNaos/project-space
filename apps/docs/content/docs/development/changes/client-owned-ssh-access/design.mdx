...
5. Keep `codex_unavailable` in the shared contract for #726, while this CLI currently owns the
   local SSH phases.
6. Reconcile the dispatch/runtime boundary with final #763 commit
   `f0d7b422bbe6007b9add605c882879fac7ddce41`; #724 does not call its start endpoint and keeps
   unavailable runtime states explicit.
