...
var (
	...
	ErrNameClaimRequired    = errors.New("claim a Project Chat registry name before using Project Chat")
	ErrNameConflict         = errors.New("this Project Chat name is already claimed or this thread already has a different name")
	ErrNameRoleForbidden    = errors.New("this Project Chat name is not allowed for the requested agent role")
